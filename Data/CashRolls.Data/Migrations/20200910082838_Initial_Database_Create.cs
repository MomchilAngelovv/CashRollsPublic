        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntryFee = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    CutPercent = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    MaxSum = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                    ParticipantsCount = table.Column<int>(nullable: false),
                    RolledOn = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rolls_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rolls_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    RollId = table.Column<string>(maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RollsUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RollsUsers_Rolls_RollId",
                        column: x => x.RollId,
                        principalTable: "Rolls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RollsUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rolls_CurrencyId",
                table: "Rolls",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Rolls_WinnerId",
                table: "Rolls",
                column: "WinnerId");

            migrationBuilder.CreateIndex(
                name: "IX_RollsUsers_RollId",
                table: "RollsUsers",
                column: "RollId");

            migrationBuilder.CreateIndex(
                name: "IX_RollsUsers_UserId",
                table: "RollsUsers",
                column: "UserId");
        }
